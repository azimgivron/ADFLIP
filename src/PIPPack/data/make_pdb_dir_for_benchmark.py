...
def main(args):
    ...
    data_dir = os.path.join(
        args.data_dir, f"top2018_{args.filter_level}_v{args.version}"
    )
    ds = Top2018Dataset(
        path=data_dir, filter_level=args.filter_level, version=args.version
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data_dir", type=str, default="/proj/kuhl_lab/users/nzrandol/protein-datasets"
    )
